...
encoder_perfect, decoder_perfect, errors_perfect = train_autoencoder(m=16, n=7, snr_db=7, chann_type="Rayleigh", batch_size=128, n_epochs=15000, lr=0.01,
...
encoder_feedback, decoder_feedback, _, errors_feedback, _ = train_autoencoder_with_feedback(m=16, n=7, snr_db=7, snr_feedback=7, compression_level=4, delay=2,
                                                                chann_type="Rayleigh", batch_size=128, n_epochs=15000, lr=0.01,
...
encoder_ml, decoder_ml, feedback_model, errors_ml, feedback_losses = train_autoencoder_with_feedback(16, 7, snr_db=7, snr_feedback=7, compression_level=4, delay=2,
                                                                chann_type="Rayleigh", batch_size=128, n_epochs=15000,lr=0.01, clipping=0.5, plot=100, stop_value=0.0001,
...
n_samples = 15000  # Nombre d'échantillons pour l'évaluation
